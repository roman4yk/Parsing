...
namespace WindowsFormsApp2
{
    ...
    public class Player
    {
            ...
            bool greatest75, double[] statistic)
        {
            ...
            string[] keys=new string[] {"AGE","GP","W","L","W_PCT","MIN","FGM",
        ...
        private void InitStatistics (string[] keys,double[] values)
        {
